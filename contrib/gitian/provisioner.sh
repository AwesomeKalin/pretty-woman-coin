...
echo "export URL=https://github.com/prettywomancoin-sv/prettywomancoin-sv.git"
echo "cd gitian-builder"
echo './bin/make-base-vm --lxc --suite xenial --arch amd64'
echo './bin/gbuild --commit prettywomancoin=${COMMIT} --url prettywomancoin=${URL} /vagrant/contrib/gitian-descriptors/gitian-linux.yml'