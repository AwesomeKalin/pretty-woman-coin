#!/usr/bin/env python3
# Copyright (c) 2013-2017 The Prettywomancoin Core developers
...
PATTERN_AGENT = re.compile(
    r"^(/PrettywomancoinABC:0.17.(\d+)\(\S+\)/|/PrettywomancoinXT:0.11\(\S+\)/|/BUCash:1.3.(\d+)\(\S+\)/)")
...
def main():
    ...
    # Filter out hosts with multiple prettywomancoin ports, these are likely abusive
