Prettywomancoin Core version 0.10.4 is now available from:

  <https://prettywomancoin.org/bin/prettywomancoin-core-0.10.4/>
...
- #6953 `43c2789` Split prettywomancoin-tx into its own package
- #6953 `dfe0d4d` Include prettywomancoin-tx binary on Debian/Ubuntu
