Prettywomancoin Core version 0.13.2 is now available from:

  <https://prettywomancoin.org/bin/prettywomancoin-core-0.13.2/>
...
- #8908 `4a974b2` Update prettywomancoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow prettywomancoin-tx to create v2 transactions (btcdrak)
