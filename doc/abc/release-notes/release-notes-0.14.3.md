Prettywomancoin ABC version 0.14.3 is now available from:

  <https://download.prettywomancoinabc.org/0.14.3/>
...
- Update prettywomancoin-tx to produce replay protected signatures
