Download URL: https://sourceforge.net/projects/prettywomancoin/files/Prettywomancoin/prettywomancoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 PWC fee schedule (users still pay 0.01 PWC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #prettywomancoin00 - #prettywomancoin99
