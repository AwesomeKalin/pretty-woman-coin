Prettywomancoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/prettywomancoin/files/Prettywomancoin/prettywomancoin-0.5.4/
...
http://gitorious.org/prettywomancoin/prettywomancoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Prettywomancoin-Qt notifications under Growl 1.3.
Increase required age of Prettywomancoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxPrettywomancoin properly when installing Prettywomancoin-Qt over it. (Windows)
