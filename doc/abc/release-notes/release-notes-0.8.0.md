Prettywomancoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/prettywomancoin/files/Prettywomancoin/prettywomancoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Prettywomancoin
...
New/changed settings (command-line or prettywomancoin.conf file)
--------------------------------------------------------
