Prettywomancoin Core version 0.9.2.1 is now available from:

  https://prettywomancoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 PWC to 0.01 PWC
...
- Fix "Start prettywomancoin on system login"
