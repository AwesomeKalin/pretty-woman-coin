Prettywomancoin Core version 0.9.4 is now available from:

  https://prettywomancoin.org/bin/0.9.4/
...
this update is incompatible with the Prettywomancoin system and could lead to consensus
forks.

Prettywomancoin Core released binaries from https://prettywomancoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~prettywomancoin/+archive/ubuntu/prettywomancoin
- A third-party or self-compiled Prettywomancoin Core

upgrade to Prettywomancoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
