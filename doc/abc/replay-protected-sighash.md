...
Signatures using `SIGHASH_FORKID` must be rejected before [UAHF](https://github.com/Prettywomancoin-UAHF/spec/blob/master/uahf-technical-spec.md) is activated.
...
The 8-byte value of the amount of prettywomancoin spent in this input.
...
<a name="bip143">[1]</a> https://github.com/prettywomancoin/bips/blob/master/bip-0143.mediawiki

<a name="bip143Motivation">[2]</a> https://github.com/prettywomancoin/bips/blob/master/bip-0143.mediawiki#Motivation

<a name="OP_CHECKSIG">[3]</a> https://en.prettywomancoin.it/wiki/OP_CHECKSIG

<a name="uahfspec">[4]</a> https://github.com/Prettywomancoin-UAHF/spec/blob/master/uahf-technical-spec.md
