...
(2) below, as formalized by BUIP040 [1] and used by the Prettywomancoin Unlimited
...
to existing pre-fork Prettywomancoin consensus rules.
...
Once the fork has activated, transactions consisting exclusively of a single OP_RETURN output, followed by a single minimally-coded data push with the specific magic data value of
    ...
    Prettywomancoin: A Peer-to-Peer Electronic Cash System
...
implementations seeking to be compliant should consult the Prettywomancoin C++
...
as "CASH" in user interfaces of some Prettywomancoin clients (BU, ABC).
...
[2] https://github.com/prettywomancoin/bips/blob/master/bip-0143.mediawiki#Motivation

[3] [Digest for replay protected signature verification accross hard forks](replay-protected-sighash.md)

[4] https://github.com/Prettywomancoin-UAHF/spec/blob/master/uahf-test-plan.md
