...
the Pretty Woman Coin Security Team.


## Pretty Woman Coin Node Implementation Release Keys

* User id: Daniel Connolly (Pretty Woman Coin binary release signing key) <d.connolly@nchain.com>
...
* User id: Richard Mills (Pretty Woman Coin binary release signing key) <r.mills@nchain.com>
...
* User id: Chris Gibson (Pretty Woman Coin binary release signing key) <c.gibson@nchain.com>
...
## Pretty Woman Coin Security Team

* User id: Pretty Woman Coin Security Team <security@prettywomancoin.io>
