...
unlocked to sign the Prettywomancoin-Qt.app bundle.
...
allowing somebody to distribute a Prettywomancoin-Qt.app or prettywomancoin-qt-setup.exe with a valid
...
that the prettywomancoin-qt.exe file inside the installer had not been tampered with.
