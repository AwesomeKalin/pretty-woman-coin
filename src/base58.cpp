...
void CPrettywomancoinSecret::SetKey(const CKey &vchSecret) {
...
CKey CPrettywomancoinSecret::GetKey() {
    CKey ret;
...
bool CPrettywomancoinSecret::IsValid() const {
...
bool CPrettywomancoinSecret::SetString(const char *pszSecret) {
    return CBase58Data::SetString(pszSecret) && IsValid();
}

bool CPrettywomancoinSecret::SetString(const std::string &strSecret) {
