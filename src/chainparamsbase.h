// Copyright (c) 2014-2015 The Prettywomancoin Core developers
 ...
 * (shared between prettywomancoin-cli and prettywomancoind)
 * of a given instance of the Prettywomancoin system.
 */
