 ...
 * for both prettywomancoind and prettywomancoin-sv, to make it harder for attackers to
 * target servers.
 */
const std::string CLIENT_NAME("Pretty Woman Coin");
 ...
 * (https://github.com/prettywomancoin/bips/blob/master/bip-0014.mediawiki)
 */
