...
// Copyright (c) 2019-2021 Prettywomancoin Association
...
/**
 * Prettywomancoin protocol message types. When adding new message types, don't forget
 ...
 * @see https://prettywomancoin.org/en/developer-reference#version
 */
extern const char *VERSION;
/**
 * The verack message acknowledges a previously-received version message,
 * informing the connecting node that it can begin to send other messages.
 * @see https://prettywomancoin.org/en/developer-reference#verack
 */
extern const char *VERACK;
/**
 * The addr (IP address) message relays connection information for peers on the
 * network.
 * @see https://prettywomancoin.org/en/developer-reference#addr
 */
extern const char *ADDR;
/**
 * The inv message (inventory message) transmits one or more inventories of
 * objects known to the transmitting peer.
 * @see https://prettywomancoin.org/en/developer-reference#inv
 */
extern const char *INV;
/**
 * The getdata message requests one or more data objects from another node.
 * @see https://prettywomancoin.org/en/developer-reference#getdata
 */
 ...
 * @see https://prettywomancoin.org/en/developer-reference#merkleblock
 */
extern const char *MERKLEBLOCK;
/**
 * The getblocks message requests an inv message that provides block header
 * hashes starting from a particular point in the block chain.
 * @see https://prettywomancoin.org/en/developer-reference#getblocks
 */
 ...
 * @see https://prettywomancoin.org/en/developer-reference#getheaders
 */
 ...
 * @see https://prettywomancoin.org/en/developer-reference#tx
 */
 ...
 * @since protocol version 31800.
 * @see https://prettywomancoin.org/en/developer-reference#headers
 */
 ...
 * @see https://prettywomancoin.org/en/developer-reference#block
 */
extern const char *BLOCK;
/**
 * The getaddr message requests an addr message from the receiving node,
 * preferably one with lots of IP addresses of other receiving nodes.
 * @see https://prettywomancoin.org/en/developer-reference#getaddr
 */
 ...
 * @see https://prettywomancoin.org/en/developer-reference#mempool
 */
extern const char *MEMPOOL;
/**
 * The ping message is sent periodically to help confirm that the receiving
 * peer is still connected.
 * @see https://prettywomancoin.org/en/developer-reference#ping
 */
 ...
 * @see https://prettywomancoin.org/en/developer-reference#pong
 */
 ...
 * @see https://prettywomancoin.org/en/developer-reference#notfound
 */
 ...
 * @see https://prettywomancoin.org/en/developer-reference#filterload
 */
 ...
 *   Only available with service bit NODE_BLOOM since protocol version
 *   70011 as described by BIP111.
 * @see https://prettywomancoin.org/en/developer-reference#filteradd
 */
 ...
 *   Only available with service bit NODE_BLOOM since protocol version
 *   70011 as described by BIP111.
 * @see https://prettywomancoin.org/en/developer-reference#filterclear
 */
 ...
 * @see https://prettywomancoin.org/en/developer-reference#reject
 */
 ...
 * @see https://prettywomancoin.org/en/developer-reference#sendheaders
 */
...
enum ServiceFlags : uint64_t {
    ...
    // It is currently set by all Pretty Woman Coin nodes, and is unset by SPV clients
    ...
    // protocol request. Pretty Woman Coin does not support this but a patch set
    // called Prettywomancoin XT does. See BIP 64 for details on how this is
    // implemented.
    NODE_GETUTXO = (1 << 1),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered
    // connections. Pretty Woman Coin nodes used to support this by default, without
    ...
    NODE_XTHIN = (1 << 4),
    // NODE_BITCOIN_CASH means the node supports Prettywomancoin Cash and the
    // associated consensus rule changes.
    // This service bit is intended to be used prior until some time after the
    // UAHF activation when the Prettywomancoin Cash network has adequately separated.
    ...
    // prettywomancoin-development mailing list. Remember that service bits are just
