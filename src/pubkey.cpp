 ...
 * the end, and overly long length descriptors. This is safe to use in Prettywomancoin
                     ...
                     const std::span<const uint8_t> signature) const
{
     ...
     * not historically been enforced in Prettywomancoin, so normalize them first.
     */
