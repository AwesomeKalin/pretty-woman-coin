...
// NOTE: Unlike wallet RPC (which use PWC values), mining RPCs follow GBT (BIP
                      ...
                      bool processedInBatch = true)
{
    if (request.fHelp || request.params.size() > 1) {
        throw std::runtime_error(
            ...
            "    "
            "https://github.com/prettywomancoin/bips/blob/master/bip-0022.mediawiki\n"
            "    "
            "https://github.com/prettywomancoin/bips/blob/master/bip-0023.mediawiki\n"
            "    "
            "https://github.com/prettywomancoin/bips/blob/master/"
            "bip-0009.mediawiki#getblocktemplate_changes\n"
            "    "
            "https://github.com/prettywomancoin/bips/blob/master/bip-0145.mediawiki\n"
    ...
    {
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "Prettywomancoin is not connected!");
    }

    if (IsInitialBlockDownload()) {
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD,
                           "Prettywomancoin is downloading blocks...");
    }
...
static UniValue verifyblockcandidate(const Config &config,
    ...
    if (request.fHelp || request.params.size() < 1 ||
        ...
        throw std::runtime_error(
            ...
            "See https://en.prettywomancoin.it/wiki/BIP_0022 for full specification.\n"
