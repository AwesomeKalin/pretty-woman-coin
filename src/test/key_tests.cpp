// Copyright (c) 2012-2015 The Prettywomancoin Core developers
...
void dumpKeyInfo(uint256 privkey) {
    ...
    for (int nCompressed = 0; nCompressed < 2; nCompressed++) {
        ...
        CPrettywomancoinSecret bsecret;
        ...
        printf("    * address (base58): %s\n",
               CPrettywomancoinAddress(vchPubKey).ToString().c_str());
    }
}
#endif
...
BOOST_AUTO_TEST_CASE(key_test1) {
    CPrettywomancoinSecret bsecret1, bsecret2, bsecret1C, bsecret2C, baddress1;
