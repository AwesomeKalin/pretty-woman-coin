...
void CWallet::AvailableCoins(std::vector<COutput> &vCoins, bool fOnlySafe,
    ...
    for (std::map<uint256, CWalletTx>::const_iterator it = mapWallet.begin();
        ...
        // Prettywomancoin-ABC: Removed check that prevents consideration of coins from
        ...
        // Prettywomancoin-ABC: retained this check as 'replaced_by_txid' is still set
        // in the wallet code.
...

    {
        ...
        while (true) {
            ...
            if (nChange > Amount(0)) {
                ...
                // transaction isn't always pay-to-prettywomancoin-address.
 ...
 * https://prettywomancointalk.org/?topic=54527, or
 * https://github.com/prettywomancoin/prettywomancoin/pull/1393.
 */
