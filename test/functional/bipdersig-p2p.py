...
class BIP66Test(PrettywomancoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # prettywomancoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and prettywomancoind produces more specific reject
            # reasons.
