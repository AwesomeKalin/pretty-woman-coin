...
Launch 3 prettywomancoind nodes.
...
Mine a >4GB block on the node.
    ...
    Verify that all real prettywomancoind nodes (version 70016) can sync to the > 4GB block.
"""
...
class BigBlockTests(PrettywomancoinTestFramework):
    ...
    def run_test(self):
        ...
        with self.run_node_with_connections("Test old and new protocol versions", 0, self.nodeArgs, number_of_connections=2,
            ...
            logger.info("Syncing prettywomancoind nodes to big block")
