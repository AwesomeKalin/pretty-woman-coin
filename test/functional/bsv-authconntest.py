...
class AuthConnTestReputation(PrettywomancoinTestFramework):
    ...
    def setup_chain(self):
        #super().setup_chain()
        # Append rpcauth to prettywomancoin.conf before initialization
        ...
        with open(os.path.join(make_datadir(0), "prettywomancoin.conf"), 'a', encoding='utf8') as f:
            f.write(rpcuser0 + "\n")
            f.write(user0 + "\n")
        ...
        with open(os.path.join(make_datadir(1), "prettywomancoin.conf"), 'a', encoding='utf8') as f:
            f.write(rpcuser1 + "\n")
            f.write(user1 + "\n")
