...
class PWCGeneratedBlockSizeActivation(PrettywomancoinTestFramework):
    ...
    def run_test(self):
        ...
        # set prettywomancoind time to be before activation time
...
if __name__ == '__main__':
    PWCGeneratedBlockSizeActivation().main()
