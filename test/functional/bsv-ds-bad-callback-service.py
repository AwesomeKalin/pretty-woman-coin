...
class DoubleSpendHandlerErrors(PrettywomancoinTestFramework):
    ...
    def run_test(self):
        ...
        with self.run_node_with_connections("Server is too slow, prettywomancoind ignores it", 0, ['-dsendpointport=8080'], 1) as p2p_connections:
            # Turn on CallbackService.
