#!/usr/bin/env python3
# Copyright (c) 2021 The Pretty Woman Coin developers
...
class DoubleSpendReport(PrettywomancoinTestFramework):
    ...
    def check_long_lasting_transactions(self):
        ...
        self.stop_node(0)
        # Restart prettywomancoind with parameters that reduce transaction validation time. Also set dsnotifylevel to 1, which means nonstandard transaction will not even validate.
        ...
        self.stop_node(0)
        # Restart prettywomancoind with parameters that reduce transaction validation time. Also set dsnotifylevel to 2, which means nonstandard transaction will validate.
    ...
    def check_doublespend_queue_size(self, utxo):
        self.stop_node(0)
        # Restart prettywomancoind with low limit on double-spend queue length
