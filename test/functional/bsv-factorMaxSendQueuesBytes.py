...
# 1. Run prettywomancoind with -factormaxsendqueuesbytes=15. Peers are requesting oldBlock.
# 2. Run prettywomancoind with -factormaxsendqueuesbytes=1. Peers are requesting oldBlock.
# 3. Run prettywomancoind with -factormaxsendqueuesbytes=1. Peers are requesting newBlock (tip of the chain).
# 4. Run prettywomancoind with -factormaxsendqueuesbytes=1. Whitelisted peers are requesting newBlock (tip of the chain).
...
class MaxSendQueuesBytesTest(PrettywomancoinTestFramework):
    ...
    def requestBlocks(self, test_nodes, block):
        ...
        # Let prettywomancoind process and send all the messages.
        for test_node in test_nodes:
    ...
    def run_test(self):
        ...
        # Scenario 1: Blocks from prettywomancoind should be sent in parallel as factormaxsendqueuesbytes=num_peers.
        ...
        # Scenario 2: Blocks from prettywomancoind should not be sent in parallel because factormaxsendqueuesbytes=1
        ...
        # Scenario 3: Blocks from prettywomancoind should not be sent in parallel if we reached rate limit,
        ...
        # Scenario 4: Blocks from prettywomancoind should be sent in parallel, because there is no limit on whitelisted peers
