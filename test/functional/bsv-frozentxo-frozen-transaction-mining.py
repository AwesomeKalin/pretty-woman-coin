...
class FrozenTXOTransactionMining(PrettywomancoinTestFramework):
    ...
    def run_test(self):
        ...
        for no in range(0, 2):
            ...
            # prettywomancoind sould not unnecessarily scan whole mempool to find transactions that spend TXOs, which could become frozen again.
        ...
        for no in range(0, 2):
            ...
            # prettywomancoind now should scan whole mempool.
