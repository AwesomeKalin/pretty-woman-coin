...
class Send_node():
    ...
    def check_log(self, line_text):
        for line in open(glob.glob(self.tmpdir + f"/node{self.node_no}" + "/regtest/prettywomancoind.log")[0]):
...
class FrozenTXOTransactionFreeze(PrettywomancoinTestFramework):
