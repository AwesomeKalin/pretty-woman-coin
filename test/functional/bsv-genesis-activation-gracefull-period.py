...
class PWCGenesisActivationGracefullPeriod(ComparisonTestFramework):

    def __init__(self):
        super(PWCGenesisActivationGracefullPeriod, self).__init__(get_lan_ip())
...
if __name__ == '__main__':
    PWCGenesisActivationGracefullPeriod().main()
