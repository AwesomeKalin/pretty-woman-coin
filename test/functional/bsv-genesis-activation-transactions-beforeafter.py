...
4. Create and send transaction tx2 with OP_TRUE in the unlocking that tries to spend tx1.
   This transaction is NOT rejected as prettywomancoind does not check if input transactions in mempool are spendable.
...
class PWCGenesisActivationTransactionsBeforeAfter(ComparisonTestFramework):
...
if __name__ == '__main__':
    PWCGenesisActivationTransactionsBeforeAfter().main()
