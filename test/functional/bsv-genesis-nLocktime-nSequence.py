...
class PWCGenesis_Restore_nLockTime_nSequence(ComparisonTestFramework):
    ...
    # Get tip from prettywomancoind and allow us to build on it
    ...
    def get_tests(self):
        ...
        # Get tip from prettywomancoind because it's further along than we are, and we want to build on it
        self.build_on_tip(2)
...
if __name__ == '__main__':
    PWCGenesis_Restore_nLockTime_nSequence().main()
