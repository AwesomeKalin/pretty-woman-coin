...
class CreateMinerInfoTest(PrettywomancoinTestFramework):
    ...
    def find_overflow_message_in_logs(self):
        with open(glob.glob(self.options.tmpdir + "/node0" + "/regtest/prettywomancoind.log")[0], encoding="utf8") as file:
            for line in file:
