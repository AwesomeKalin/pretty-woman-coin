...
# not implemented by current version of prettywomancoind
...
class BsvProtoconfVersionsCompatibility(PrettywomancoinTestFramework):
    ...
    def run_test(self):
        ...
        # 1. test
        # Send protoconf with 0 fields. Prettywomancoind should disconnect the node, since minimum number of fields is 1
        ...
        # In that way it is sure that prettywomancoind does not just take default (1MiB value).
        ...
        with run_connection(test_node, "2 fields"):
            ...
            # 3.1. Receive prettywomancoind's protoconf (currently 2MiB) and send it Inv message
            ...
            logger.info("Received prettywomancoind max message size: {} B, which represents {} elements. ".format(max_recv_payload_length, maxInvElements))

            # 3.2. Send prettywomancoind Inv message (should be 2MiB)
