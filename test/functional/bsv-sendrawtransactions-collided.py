...
from test_framework.test_framework import PrettywomancoinTestFramework, ToHex, FromHex
from test_framework.util import assert_equal, wait_until
from test_framework.mininode import CTxIn, COutPoint


class PWCsendrawtransactionsCollided(PrettywomancoinTestFramework):
...
if __name__ == '__main__':
    PWCsendrawtransactionsCollided().main()
