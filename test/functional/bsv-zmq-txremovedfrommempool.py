...
from test_framework.test_framework import PrettywomancoinTestFramework, SkipTest, ToHex, FromHex
...
class ZMQRemovedFromMempool(PrettywomancoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that prettywomancoin has been built with ZMQ enabled and we have python zmq package installed.
        check_zmq_test_requirements(self.options.configfile,
                                    SkipTest("prettywomancoind has not been built with zmq enabled."))
