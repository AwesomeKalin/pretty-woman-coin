...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the PrettywomancoinTestFramework
    pass


class ExampleTest(PrettywomancoinTestFramework):
    # Each functional test is a subclass of the PrettywomancoinTestFramework class.
    ...
    def custom_method(self):
        ...
        PrettywomancoinTestFramework class so other tests can use it."""
