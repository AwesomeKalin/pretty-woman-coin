...
class MempoolEvictionPriorityTest(PrettywomancoinTestFramework):
    mempool_size = 300
    ...
    def run_test(self):
        ...
        # size: 6MiB, fee: 10,000,000 satoshi (0.1 PWC) --> fee rate: 1.6 sat/byte
        ...
        # size: 6MiB, fee: 2,500,000 satoshi (0.025 PWC) --> fee rate: 0.4 sat/byte
        ...
        # size: 42MiB, fee: 35,000,000 satoshi (0.35 PWC) --> fee rate: 0.8 sat/byte
