...
# 1. Send transaction (cca 5MB) with smaller fee rate (0.00000399 PWC/kB).
# 2. Send 29 big transactions (cca 10MB per one) with higher fee rate (0.00000999 PWC/kB).
# 3. Send another transaction with the same size as the first one and higher fee rate (0.00001999 PWC/kB).
...
class MempoolLimitTest(PrettywomancoinTestFramework):
    ...
    def run_test(self):
        ...
        # size: 5000211B, fee: 2000000 satoshi (0.02 PWC) --> fee rate: 0.399 sat/byte which is 0.00000399 PWC/kB
        ...
        # size: 10000211B, fee: 10000000 satoshi (0.1 PWC) --> fee rate: 0.999 sat/byte which is 0.00000999 PWC/kB
        ...
        # size: 5000211B, fee: 10000000 satoshi (0.1 PWC) --> fee rate: 1.999 sat/byte which is 0.00001999 PWC/kB
