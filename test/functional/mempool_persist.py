#!/usr/bin/env python3
# Copyright (c) 2014-2017 The Prettywomancoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test mempool persistence.

By default, prettywomancoind will dump mempool on shutdown and
...
class MempoolPersistTest(PrettywomancoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give prettywomancoind a second to reload the mempool
        time.sleep(1)
