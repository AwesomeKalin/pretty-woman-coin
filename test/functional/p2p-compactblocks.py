...
# TestNode: A peer we use to send messages to prettywomancoind, and store responses.
...
class CompactBlocksTest(PrettywomancoinTestFramework):
    ...
    # This test actually causes prettywomancoind to (reasonably!) disconnect us, so do
    # this last.
    ...
    # prettywomancoind's choice of nonce.
    ...
    # Test that prettywomancoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for prettywomancoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # prettywomancoind will not send blocktxn responses for blocks whose height is
