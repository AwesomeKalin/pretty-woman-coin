...
class TxnMallTest(PrettywomancoinTestFramework):
    ...
    def setup_network(self):
        ...
        # Create a 200-block-long chain. Each of the 4 nodes gets 25 mature blocks with 1250 PWC
        for i in range(2):
                for peer in range(4):
                    for j in range(25):
    ...
    def run_test(self):
        # All nodes should start with 1,250 PWC:
        ...
        # 40 PWC serialized is 00286bee00000000
        pos0 = 2 * (4 + 1 + 36 + 1 + 4 + 1)
        ...
        # Node0's balance should be starting balance, plus 50PWC for another
        ...
        # Check node0's total balance; should be same as before the clone, + 100 PWC for 2 matured,
