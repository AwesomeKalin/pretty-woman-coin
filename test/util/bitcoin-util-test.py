...
# Copyright 2016-2017 The Prettywomancoin Core developers
...
"""Test framework for prettywomancoin utils.
...
def main():
    ...
    bctester(os.path.join(config["environment"]["SRCDIR"], "test", "util", "data"),
             "prettywomancoin-util-test.json", config["environment"], args.buildconfig)
...
def bctest(testDir, testObj, buildenv, buildconfig):
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, prettywomancoin-tx
