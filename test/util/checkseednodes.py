...
dnsseeds_mainnet = [("prettywomancoin.io", "seed.prettywomancoin.io"),
                    ("cascharia.com", "seed.cascharia.com"),
                    ("satoshisvision.network", "seed.satoshisvision.network")]
dnsseeds_stn = [("prettywomancoin.io", "stn-seed.prettywomancoin.io")]
dnsseeds_testnet = [("prettywomancoin.io", "testnet-seed.prettywomancoin.io"),
                    ("cascharia.com", "testnet-seed.cascharia.com"),
                    ("prettywomancoincloud.net", "testnet-seed.prettywomancoincloud.net")]
